...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "a1_real_world": [
        ...
        ("berkeley_fanuc_manipulation", 2.0),
        ("bc_z", 0.2),  
        # not used in x-square robot   
        ("roboturk", 0.005),
        ("toto", 0.005),
        ("ucsd_kitchen_dataset_converted_externally_to_rlds", 0.01),
        ("iamlab_cmu_pickup_insert_converted_externally_to_rlds", 0.005),
    ],
    ...
    "libero_4_task_suites_no_noops_extra_10_task_8": [
        ("libero_spatial_no_noops", 1.0),
        ("libero_object_no_noops", 1.0),
        ("libero_goal_no_noops", 1.0),
        ("libero_10_no_noops", 1.0),
        ("libero_10_no_noops_task_8", 3.0),
    ],
    "libero_4_task_suites_no_noops_extra_10_task_8_6": [
        ("libero_spatial_no_noops", 1.0),
        ("libero_object_no_noops", 1.0),
        ("libero_goal_no_noops", 1.0),
        ("libero_10_no_noops", 1.0),
        ("libero_10_no_noops_task_8", 3.0),
        ("libero_10_no_noops_task_6", 1.0),
    ],
