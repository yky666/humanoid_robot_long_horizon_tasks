...
robot_control_dir = os.path.dirname(os.path.abspath(__file__))
teleop_dir = os.path.dirname(robot_control_dir)
repo_root = os.path.dirname(teleop_dir)
dex_retargeting_src = os.path.join(robot_control_dir, "dex-retargeting", "src")

if dex_retargeting_src not in sys.path:
    sys.path.insert(0, dex_retargeting_src)
...
class HandType(Enum):
    INSPIRE_HAND = os.path.join(repo_root, "assets", "inspire_hand", "inspire_hand.yml")
    INSPIRE_HAND_Unit_Test = os.path.join(repo_root, "assets", "inspire_hand", "inspire_hand.yml")
    UNITREE_DEX3 = os.path.join(repo_root, "assets", "unitree_hand", "unitree_dex3.yml")
    UNITREE_DEX3_Unit_Test = os.path.join(repo_root, "assets", "unitree_hand", "unitree_dex3.yml")
    BRAINCO_HAND = os.path.join(repo_root, "assets", "brainco_hand", "brainco.yml")
    BRAINCO_HAND_Unit_Test = os.path.join(repo_root, "assets", "brainco_hand", "brainco.yml")
