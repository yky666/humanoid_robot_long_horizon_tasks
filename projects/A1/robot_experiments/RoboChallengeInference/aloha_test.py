...
from aloha_demo import GPUClient, DummyPolicy
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='Task name (e.g. clean_dining_table, stack_bowls). Prompt is resolved from task_config.',
    )
    parser.add_argument(
        '--save-plot',
        type=str,
        default='aloha_open_loop.png',
