...
def get_dataset_statistics(
    ...
    # print(f"****************** olmo/data/vla/rlds/utils/data_utils.py, get_dataset_statistics, before loading metadata")
    # check if cache file exists and load
    if tf.io.gfile.exists(path):
        log.info(f"Loading existing dataset statistics from {path}.")
        with tf.io.gfile.GFile(path, "r") as f:
            metadata = json.load(f)
        # print(f"****************** olmo/data/vla/rlds/utils/data_utils.py, get_dataset_statistics: return metadata")
        return metadata
    ...
    log.info("Computing dataset statistics. This may take a bit, but should only need to happen once.")
    ...
    try:
        ...
        log.warning(f"Could not write dataset statistics to {path}. Writing to {local_path} instead.")
...
def save_dataset_statistics(dataset_statistics, run_dir):
    ...
    log.info(f"Saved dataset statistics file at path {out_path}")
