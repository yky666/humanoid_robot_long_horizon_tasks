...
class DummyPolicy:
    ...
    def run_policy(self, input_data):
        ...
        """
        input_data['action'] = input_data['action'][:6] + [input_data['action'][-1]*10]
        payload = {
...
def main():
    ...
    parser.add_argument('--task_name', type=str, required=True, help='Task name (e.g. arrange_flowers, open_the_drawer). Prompt is resolved from task_config.')
    ...
    action_type = "leftjoint" # this refers to both README.md#get-state and README.md#post-action parameters `action_type`
