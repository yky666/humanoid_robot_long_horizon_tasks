...
This folder is the managed snapshot of the local `dex-retargeting` workspace on
this machine.
...
- Upstream repository: `https://github.com/dexsuite/dex-retargeting.git`
- Upstream base commit: `3f56141bc8bd2760d5e452e382937269554ebb21`
- Source local path: `/home/sys01/yangky/test/dex-retargeting`

## Local Changes Included In This Snapshot

- Modified `example/vector_retargeting/README.md`
- Modified `example/vector_retargeting/render_robot_hand.py`
- Modified `example/vector_retargeting/show_realtime_retargeting.py`
- Modified `example/vector_retargeting/single_hand_detector.py`
- Modified `pyproject.toml`
- Modified `src/dex_retargeting/constants.py`
- Added custom example data under `example/vector_retargeting/data/`
- Added local helper scripts for realtime retargeting workflows
- Added `ftp-hands/` hand assets and related robot descriptions
- Added `src/dex_retargeting/configs/*rh56dftp*` configuration files

## Excluded From Version Control

- local build directories such as `build/`
- local environments such as `.venv/`
- transient runtime directories such as `log/` and `temp/`
