...
from franka_demo import GPUClient, DummyPolicy
...
def main():
    ...
    parser.add_argument('--task_name', type=str, required=True, help='Task name. Prompt is resolved from task_config.')
    parser.add_argument(
        '--save-plot',
        type=str,
        default='franka_open_loop.png',
