...
export dataset_name=vla_dataset_dobot
vla_config_path="dobot.yaml"
exp_name="a1_dobot"
...
BATCH_PER_GPU=8   # Batch size per GPU, can be overridden with --batch_size
