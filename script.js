const robots = [
  {
    ...
    eef: "双臂+末端夹爪",
    safety: "关节限位+跌倒保护",
    asset: "assets/models/songyan_n2/n2.urdf",
    assetState: "官方参数 URDF 预览",
    route: "GVHMR/GMR → N2 RobotAdapter → LeRobot/GR00T",
  ...
  {
    name: "Allegro / RH56DFTP",
    tag: "灵巧手",
    dof: "16-20 DoF",
    eef: "五指骨骼链",
    safety: "指关节限位+接触力边界",
    asset: "assets/models/rh56dftp/rh56dftp_hand.urdf",
    assetState: "RH56DFTP benchmark 已接入视频",
    route: "MANO/手套骨骼 → RH56DFTP 指关节 → BC/RL 微调",
